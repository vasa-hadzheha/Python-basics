...
├── exercise-bank/            60+ graded exercises (statement → hint → solution)
...
Exercise material derives from the author's own Python lab work
(`archive/original-labs-ua/`), translated into English and reorganised into a
teachable sequence. The data-engineering modules in Meeting 3 are new.
